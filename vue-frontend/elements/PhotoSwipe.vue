<template>
  <div class="el-photoswipe">
    <div class="el-photoswipe--gallery" itemscope itemtype="http://schema.org/ImageGallery">
      ...
      <figure
        ...
        <a
            ...
            :href="item.src" style="display: flex" class="anchor" itemprop="contentUrl" :data-size="'' + item.w + 'x' + item.h" :title="item.title">
      ...
      <div class="pswp__scroll-wrap">
        ...
        <div class="pswp__ui pswp__ui--hidden">
          ...
          <div class="pswp__top-bar">
            ...
            <button class="pswp__button pswp__button--rotate pswp__button--rotate--left" title="Rotate left"
                    v-if="options.rotationOn" @click="rotate(-90)"></button>
            <button class="pswp__button pswp__button--rotate pswp__button--rotate--right" title="Rotate right"
                    v-if="options.rotationOn" @click="rotate(90)"></button>
...
export default {
  ...
  methods: {
    init() {
        ...
        let openPhotoSwipe = function (index, galleryElement, disableAnimation, fromURL) {
          ...
          options = {
            ...
            getThumbBoundsFn: function (index) {
              ...
              let thumbnail = items[index].el.querySelector(".anchor > *"), // find thumbnail
      ...
      initPhotoSwipeFromDOM('.el-photoswipe--gallery');
    },
